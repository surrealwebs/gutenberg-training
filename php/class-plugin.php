<?php
/**
 * Bootstraps the Gutenberg Training plugin.
 *
...
class Plugin extends Plugin_Base {
	...
	public function init() {
		$this->config = apply_filters( 'gutenberg_training_plugin_config', $this->config, $this );
	...
	public function enqueue_block_editor_assets() {
		wp_enqueue_script(
			'gutenberg-training-block-editor-js',
		...
		wp_enqueue_style(
			'gutenberg-training-block-editor-css',
	...
	public function enqueue_front_end_assets() {
		wp_enqueue_script(
			'gutenberg-training-front-end-js',
		...
		wp_enqueue_style(
			'gutenberg-training-front-end-css',
